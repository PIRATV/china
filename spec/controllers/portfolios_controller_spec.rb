  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved portfolio as @portfolio" do
        ...
        post :create, {:portfolio => {  }}, valid_session
        expect(assigns(:portfolio)).to be_a_new(Portfolio)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested portfolio" do
        ...
        expect_any_instance_of(Portfolio).to receive(:update).with({ "these" => "params" })
        put :update, {:id => portfolio.to_param, :portfolio => { "these" => "params" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the portfolio as @portfolio" do
        portfolio = Portfolio.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Portfolio).to receive(:update).and_return(false)
        put :update, {:id => portfolio.to_param, :portfolio => {  }}, valid_session
        expect(assigns(:portfolio)).to eq(portfolio)
      end
