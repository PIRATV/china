  ...
  jQuery(function() {
    ...
    $("#license span").click(function() {
      ...
      if (input.checked) {
        ...
        return $("#btn").attr('type', 'button');
      }
    });
    return $("#license input").click(function() {
      if (this.checked) {
        $("#btn").removeClass('inactive');
        return $("#btn").attr('type', 'submit');
      } else {
...
(function() {
  jQuery(function() {
    ...
    return $(window).on('ajaxComplete', function() {
      return $('.portfolio').gpGallery('a');
    });
  });
...
(function() {
  jQuery(function() {
    $('#profilePage a.edit_info').click(function() {
      if ($(this).parent().children('input').length) {
        !$($(this).parent().children('input')).removeClass('hidden');
        $($(this).parent().children('input')).focus();
      } else if ($(this).parent().children('textarea').length) {
        !$($(this).parent().children('textarea')).removeClass('hidden');
    ...
    $('#profilePage input').blur(function() {
      if (this.value !== $(this).parent().children('span').html().trim()) {
        $('.edit_user').submit();
      }
      $(this).addClass('hidden');
      return $(this).parent().children('span').html(this.value);
    });
    $('#profilePage textarea').blur(function() {
    ...
    $('#profilePage select').blur(function() {
      if (this.value !== $(this).parent().children('span').html()) {
        $('.edit_user').submit();
      }
      $(this).addClass('hidden');
      return $(this).parent().children('span').html($(this).find(':selected').text());
    });
